...
# -------------------GENERIC VIEW SMALL METHOD--------------------------
# We also use only ListAPIView if we don't want to Add Data
...
class JobApplications(generics.ListCreateAPIView):
